...
import {View, Text, StyleSheet, Image, ScrollView, Modal, Button, TouchableHighlight} from 'react-native';
      ...
      <Modal transparent = {true} animationType="slide" visible={modalVisibleplaya} onRequestClose = {() => {
        ...
        <View style={styles.vistaModal}>
          <View style={styles.Modal}>
            ...
            <Button tittle="Cerrar" onPress={() => {setModalVisibleplaya(!modalVisibleplaya)}}></Button>
          </View>
        </View>
      </Modal>
